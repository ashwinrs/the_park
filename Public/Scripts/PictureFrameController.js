...
for (var j = 0; j < framePieces.length; j++) {
    framePieces[j].getComponent("Component.MaterialMeshVisual").mainMaterial = frameMaterial;
}
...
function adjustForAspectRatio() {
    ...
    // Get wide aspect ratio
        aspectRatio = scaledHeight / scaledWidth;
